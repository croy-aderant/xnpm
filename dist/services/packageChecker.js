...
export async function getOutdatedPackages(specificPackages = []) {
    try {
        ...
        try {
            const output = execSync(`npm outdated --json ${packagesToCheck.join(' ')}`, { encoding: 'utf-8', stdio: 'pipe', maxBuffer: 10 * 1024 * 1024 });
...
//# sourceMappingURL=packageChecker.js.map