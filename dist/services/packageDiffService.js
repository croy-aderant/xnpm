...
export async function getPackageDiff(packageName, currentVersion, latestVersion) {
    // Clean versions
...
async function fetchAndExtractPackage(packageName, version, targetDir) {
    try {
...
async function compareDirectories(currentDir, latestDir, packageName) {
    const files = [];
...
//# sourceMappingURL=packageDiffService.js.map