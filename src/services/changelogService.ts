...
async function tryFetchChangelogFromGitHub(repoUrl: string): Promise<string | null> {
  try {
...
function parseChangelog(content: string, fromVersion: string, toVersion: string): PackageChange[] {
  const changes: PackageChange[] = [];
